    ...
    setData(prev => ({
      ...
      experience: prev.experience.map((exp, i) =>
        i === expIndex
          ? {
              ...exp,
              jobDescription: exp.jobDescription.filter((_, j) => j !== descIndex)
            }
          : exp
      )
    }));
        ...
        <section key={i} className="experience-entry">
          ...
          <label>Company Name
            <input
              ...
              onChange={e => handleFieldChange(i, 'companyName', e.target.value)}
            />
          </label>
          <label>From
            <input
            ...
            <ul>
              {exp.jobDescription.map((desc, j) => (
                <li key={j}>
                  ...
                  />
                  <button type="button" onClick={() => handleDeleteJobDesc(i, j)}>X</button>
                </li>
              ))}
            </ul>
